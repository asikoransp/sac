...
const chartJs = () => function () {
    !(function (t, e) {
        ...
        const V = (t, e) => "string" == typeof t && t.endsWith("%")
            ? parseFloat(t) / 100
            : +t / e, B = (t, e) => "string" == typeof t && t.endsWith("%")
            ? (parseFloat(t) / 100) * e
            : +t;
        function d(t, e, i) {
        ...
        const S = Math.PI, _ = 2 * S, Q = _ + S, tt = Number.POSITIVE_INFINITY, et = S / 180, D = S / 2, it = S / 4, st = (2 * S) / 3, r = Math.log10, y = Math.sign;
        function at(t, e, i) {
        ...
        const Dt = (t) => "start" === t ? "left" : "end" === t ? "right" : "center", E = (t, e, i) => ("start" === t ? e : "end" === t ? i : (e + i) / 2), Ct = (t, e, i, s) => t === (s ? "left" : "right") ? i : "center" === t ? (e + i) / 2 : e;
        function Ot(t, e, i) {
            var s = e.length;
            let a = 0, n = s;
            if (t._sorted) {
                ...
                d &&
                    (a = C(Math.min(f(r, l, h).lo, i ? s : f(e, l, o.getPixelForValue(h)).lo), 0, s - 1)),
                    (n = u
        ...
        const n = {
            ...
            e: 14,
            f: 15,
        }, zt = [..."0123456789ABCDEF"], Ft = (t) => zt[15 & t], Vt = (t) => zt[(240 & t) >> 4] + zt[15 & t], Bt = (t) => (240 & t) >> 4 == (15 & t);
        const Wt = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
        function Nt(i, t, s) {
            const a = t * Math.min(s, 1 - s), e = (t, e = (t + i / 30) % 12) => s - a * Math.max(Math.min(e - 3, 9 - e, 1), -1);
            return [e(0), e(8), e(4)];
        }
        function Ht(i, s, a) {
        ...
        let Gt;
        const Zt = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/, Jt = (t) => t <= 0.0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - 0.055, Qt = (t) => t <= 0.04045 ? t / 12.92 : Math.pow((t + 0.055) / 1.055, 2.4);
        function te(e, i, s) {
            if (e) {
                let t = Yt(e);
        ...
        class ae {
            ...
            mix(t, e) {
                if (t) {
                    ...
                    var t = void 0 === e ? 0.5 : e, e = 2 * t - 1, i = s.a - a.a, e = (1 + (e * i == -1 ? e : (e + i) / (1 + e * i))) / 2, i = 1 - e;
            ...
            greyscale() {
                const t = this._rgb, e = Tt(0.3 * t.r + 0.59 * t.g + 0.11 * t.b);
        ...
        const le = ["x", "y", "borderWidth", "radius", "tension"], he = ["color", "borderColor", "backgroundColor"], ce = new Map();
        function de(t, e, a) {
            return (function (t, e) {
                e = a || {};
        ...
        function Ee(t, e, i, s) {
            let a = ((s = s || {}).data = s.data || {}), n = (s.garbageCollect = s.garbageCollect || []), o = (s.font !== e &&
        ...
        function $e(s, e, i, a) {
            ...
            return new Proxy(t, {
                ...
                getOwnPropertyDescriptor: (t, e) => t._descriptors.allKeys
                    ? Reflect.has(s, e)
        ...
        const Xe = (t, e) => (t ? t + K(e) : e), qe = (t, e) => A(e) &&
            "adapters" !== t &&
        ...
        const si = Number.EPSILON || 1e-14, ai = (t, e) => e < t.length && !t[e].skip && t[e], ni = (t) => ("x" === t ? "y" : "x");
        function oi(t, e, i, s) {
        ...
        const ci = (t) => 0 === t || 1 === t, di = (t, e, i) => -Math.pow(2, 10 * --t) * Math.sin(((t - e) * _) / i), ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * _) / i) + 1, gi = {
            linear: (t) => t,
            easeInQuad: (t) => t * t,
            easeOutQuad: (t) => -t * (t - 2),
        ...
        function z(t, e) {
            e = e || R.font;
            let i = T((t = t || {}).size, e.size), s = ("string" == typeof i && (i = parseInt(i, 10)),
                T(t.style, e.style));
            s &&
                !("" + s).match(xi) &&
        ...
        function Ii(t, e, s, a) {
            if (a && a.setContext && s) {
                var r = t, t = e, l = s, h = a;
                const d = r._chart.getContext(), u = zi(r.options), { _datasetIndex: g, options: { spanGaps: f }, } = r, p = l.length, m = [];
        ...
        var Hi = {
            ...
            modes: {
                index(t, e, i, s) {
                    const a = Se(e, t), n = i.axis || "x", o = i.includeInvisible || !1, r = i.intersect ? Bi(t, a, n, s, o) : Wi(t, a, n, !1, s, o), l = [];
                    return r.length
        ...
        var a = {
            ...
            update(l, t, e, i) {
                if (l) {
                    const o = I(l.options.layout.padding), r = Math.max(t - o.width, 0), h = Math.max(e - o.height, 0), c = (function () {
                        const t = (function (t) {
                            const e = [];
                            let i, s, a, n, o, r;
                            for (i = 0, s = (t || []).length; i < s; ++i)
                            ...
                            return e;
                        })(l.boxes), e = Ui(t.filter((t) => t.box.fullSize), !0), i = Ui(Yi(t, "left"), !0), s = Ui(Yi(t, "right")), a = Ui(Yi(t, "top"), !0), n = Ui(Yi(t, "bottom")), o = $i(t, "x"), r = $i(t, "y");
                        return {
                            fullSize: e,
                    ...
                    var s = d.reduce((t, e) => e.box.options && !1 === e.box.options.display ? t : t + 1, 0) || 1, t = Object.freeze({
                        outerWidth: t,
                        outerHeight: e,
                        padding: o,
                        availableWidth: r,
        ...
        class xs {
            ...
            _createAnimations(e, i) {
                const s = this._properties, a = [], n = e.$animations || (e.$animations = {}), t = Object.keys(i), o = Date.now();
                let r;
        ...
        class Os {
            ...
            linkScales() {
                const t = this.chart, e = this._cachedMeta, i = this.getDataset(), s = (t, e, i, s) => ("x" === t ? e : "r" === t ? s : i), a = (e.xAxisID = T(i.xAxisID, Ss(t, "x"))), n = (e.yAxisID = T(i.yAxisID, Ss(t, "y"))), o = (e.rAxisID = T(i.rAxisID, Ss(t, "r"))), r = e.indexAxis, l = (e.iAxisID = s(r, a, n, o)), h = (e.vAxisID = s(r, n, a, o));
            ...
            getMinMax(e, t) {
                const i = this._cachedMeta, s = i._parsed, a = i._sorted && e === i.iScale, n = s.length, o = this._getOtherScale(e), r = ((d = this.chart),
                    t &&
                        !i.hidden &&
            ...
            update(t) { }
            draw() {
                const t = this._ctx, e = this.chart, i = this._cachedMeta, s = i.data || [], a = e.chartArea, n = [], o = this._drawStart || 0, r = this._drawCount || s.length - o, l = this.options.drawActiveElementsOnTop;
                let h;
            ...
            _resolveElementOptions(t, e = "default", i) {
                const s = "active" === e, a = this._cachedDataOpts, n = t + "-" + e, o = a[n], r = this.enableOptionSharing && G(i);
                if (o)
                    return Cs(o, r);
                const l = this.chart.config, h = l.datasetElementScopeKeys(this._type, t), c = s ? [t + "Hover", "hover", t, ""] : [t, ""], d = l.getOptionScopes(this.getDataset(), h), u = Object.keys(R.elements[t]), g = l.resolveNamedOptions(d, u, () => this.getContext(i, s, e), c);
            ...
            _resolveAnimations(t, e, i) {
                ...
                if (!1 !== s.options.animation) {
                    const s = this.chart.config, a = s.datasetAnimationScopeKeys(this._type, e), n = s.getOptionScopes(this.getDataset(), a);
        ...
        class zs extends e {
            ...
            getUserBounds() {
                var { _userMin: t, _userMax: e, _suggestedMin: i, _suggestedMax: s, } = this, t = g(t, Number.POSITIVE_INFINITY), e = g(e, Number.NEGATIVE_INFINITY), i = g(i, Number.POSITIVE_INFINITY), s = g(s, Number.NEGATIVE_INFINITY);
                return {
                    min: g(t, i),
                    max: g(e, s),
                    minDefined: p(t),
            ...
            update(t, e, i) {
                var { beginAtZero: s, grace: a, ticks: n } = this.options, o = n.sampleSize, t = (this.beforeUpdate(),
                    (this.maxWidth = t),
                    (this.maxHeight = e),
                    (this._margins = i =
                ...
                this._convertTicksToLabels(t ? Es(this.ticks, o) : this.ticks),
                    ...
                    n.display &&
                        ...
                        ((this.ticks = (function (t, s) {
                            const e = t.options.ticks, i = ((c = (t = t).options.offset),
                                (d = t._tickSize()),
                                (c = t._length / d + (c ? 0 : 1)),
                                (t = t._maxLength / d),
                            ...
                            if (0 < o) {
                                ...
                                for (As(s, h, m, P(i) ? 0 : r - i, r), t = 0, e = o - 1; t < e; t++)
                                    As(s, h, m, n[t], n[t + 1]);
            ...
            fit() {
                const t = { width: 0, height: 0 }, { chart: e, options: { ticks: i, title: s, grid: a }, } = this, n = this._isVisible(), o = this.isHorizontal();
                if (n) {
            ...
            _calculatePadding(i, s, a, n) {
                ...
                if (this.isHorizontal()) {
                    const l = this.getPixelForTick(0) - this.left, d = this.right - this.getPixelForTick(this.ticks.length - 1);
                    let t = 0, e = 0;
                    h
                        ? (e = c
            ...
            _computeGridLineItems(t) {
                ...
                const i = this.axis, s = this.chart, a = this.options, { grid: n, position: o, border: r } = a, l = n.offset, h = this.isHorizontal(), c = this.ticks.length + (l ? 1 : 0), d = Rs(n), u = [], g = r.setContext(this.getContext()), f = g.display ? g.width : 0, p = f / 2;
                ...
                for (b = 0; b < c; b += C) {
                    const t = this.getContext(b), i = n.setContext(t), a = r.setContext(t), A = i.lineWidth, o = i.color, T = a.dash || [], c = a.dashOffset, d = i.tickWidth, g = i.tickColor, f = i.tickBorderDash || [], p = i.tickBorderDashOffset;
                    void 0 !==
                        (x = (function (t, e, i) {
            ...
            _computeLabelItems(s) {
                const a = this.axis, n = this.options, { position: o, ticks: e } = n, r = this.isHorizontal(), l = this.ticks, { align: h, crossAlign: c, padding: t, mirror: d } = e, i = Rs(n.grid), u = i + t, g = d ? -t : u, f = -L(this.labelRotation), p = [];
                ...
                for (m = 0, b = l.length; m < b; ++m) {
                    x = l[m].label;
                    const s = e.setContext(this.getContext(m)), a = ((M = this.getPixelForTick(m) + e.labelOffset),
                        (k = (w = this._resolveTickFontOptions(m)).lineHeight),
                        (S = O(x) ? x.length : 1) / 2), n = s.color, A = s.textStrokeColor, h = s.textStrokeWidth;
                    let i, t = y;
                    if ((r
                        ? ((v = M),
                            "inner" === y &&
            ...
            _getYAxisLabelAlignment(t) {
                var { position: e, ticks: { crossAlign: i, mirror: s, padding: a }, } = this.options, t = t + a, n = this._getLabelSizes().widest.width;
                let o, r;
                return ("left" === e
                    ? s
                        ? ((r = this.right + a),
            ...
            drawGrid(t) {
                const e = this.options.grid, s = this.ctx, i = this._gridLineItems ||
                            ...
                            e.defaultRoutes &&
                                ((r = s),
                                    ...
                                    Object.keys(l).forEach((t) => {
                                        const e = t.split("."), i = e.pop(), s = [r].concat(e).join("."), a = l[t].split("."), n = a.pop(), o = a.join(".");
                                        R.route(s, i, o, n);
                                    })),
        ...
        class Vs {
            ...
            _notifyStateChanges(t) {
                var e = this._oldCache || [], i = this._cache, s = (t, i) => t.filter((e) => !i.some((t) => e.plugin.id === t.plugin.id));
        ...
        const Zs = (i) => A(i) &&
            Object.getOwnPropertyNames(i).reduce((t, e) => t || u(i[e]), !1), Js = ["top", "bottom", "left", "right", "chartArea"];
        function Qs(t, e) {
        ...
        class i {
            ...
            buildOrUpdateScales() {
                const o = this.options, s = o.scales, r = this.scales, l = Object.keys(r).reduce((t, e) => ((t[e] = !1), t), {});
                let t = [];
                k((t = s
                    ? t.concat(Object.keys(s).map((t) => {
            ...
            update(t) {
                const s = this.config, a = (s.update(),
            ...
            _getUniformDataChanges() {
                ...
                if (t && t.length) {
                    this._dataChanges = [];
                    var e = this.data.datasets.length, i = (e) => new Set(t
                        .filter((t) => t[0] === e)
                        .map((t, e) => e + "," + t.splice(1).join(","))), s = i(0);
                    for (let t = 1; t < e; t++)
                        if (!Z(s, i(t)))
                            return;
                    return Array.from(s)
            ...
            _updateHoverStyles(t, e, i) {
                var s = this.options.hover, a = (t, i) => t.filter((e) => !i.some((t) => e.datasetIndex === t.datasetIndex && e.index === t.index)), n = a(e, t), i = i ? t : a(t, e);
            ...
            _handleEvent(t, e, i) {
                const { _active: s = [], options: a } = this, n = e, o = this._getActiveElements(t, s, i, n), r = J(t), l = ((h = t),
                    (c = this._lastEvent),
        ...
        class pa extends Os {
            ...
            update(t) {
                const e = this.chart, i = e["chartArea"], s = this._cachedMeta, a = s.data, n = this.getMaxBorderWidth() +
                    this.getMaxOffset(a) +
                    this.options.spacing, o = Math.max((Math.min(i.width, i.height) - n) / 2, 0), r = Math.min(V(this.options.cutout, o), 1), l = this._getRingWeight(this.index), { circumference: h, rotation: c } = this._getRotationExtents(), { ratioX: d, ratioY: u, offsetX: g, offsetY: f, } = (function (t, e, s) {
                    let i = 1, a = 1, n = 0, o = 0;
                    if (e < _) {
                        const r = t, l = r + e, h = Math.cos(r), c = Math.sin(r), d = Math.cos(l), u = Math.sin(l), g = (t, e, i) => pt(t, r, l, !0) ? 1 : Math.max(e, e * s, i, i * s), f = (t, e, i) => pt(t, r, l, !0) ? -1 : Math.min(e, e * s, i, i * s), p = g(0, h, d), m = g(D, c, u), b = f(S, h, d), x = f(S + D, c, u);
                        (i = (p - b) / 2),
                            (a = (m - x) / 2),
                            (n = -(p + b) / 2),
                            (o = -(m + x) / 2);
                ...
                })(c, h, r), p = (i.width - n) / d, m = (i.height - n) / u, b = Math.max(Math.min(p, m) / 2, 0), x = B(this.options.radius, b), v = (x - Math.max(x * r, 0)) / this._getVisibleDatasetWeightTotal();
                (this.offsetX = g * x),
                    (this.offsetY = f * x),
            ...
            updateElements(t, e, i, s) {
                const a = "reset" === s, n = this.chart, o = n.chartArea, r = n.options.animation, l = (o.left + o.right) / 2, h = (o.top + o.bottom) / 2, c = a && r.animateScale, d = c ? 0 : this.innerRadius, u = c ? 0 : this.outerRadius, { sharedOptions: g, includeOptions: f } = this._getSharedOptions(e, s);
        ...
        class ma extends Os {
            ...
            _updateRadius() {
                const t = this.chart, e = t.chartArea, i = t.options, s = Math.min(e.right - e.left, e.bottom - e.top), a = Math.max(s / 2, 0), n = (a -
            ...
            updateElements(s, a, t, n) {
                const o = "reset" === n, r = this.chart, l = r.options.animation, h = this._cachedMeta.rScale, c = h.xCenter, d = h.yCenter, u = h.getIndexAngle(0) - 0.5 * S;
                let g, f = u;
                ...
                for (g = a; g < a + t; g++) {
                    const a = s[g];
                    let t = f, e = f + this._computeAngle(g, n, p), i = r.getDataVisibility(g)
        ...
        var ba = Object.freeze({
            ...
            BarController: class extends Os {
                ...
                parseObjectData(t, e, i, s) {
                    const { iScale: a, vScale: n } = t, { xAxisKey: o = "x", yAxisKey: r = "y" } = this._parsing, l = "x" === a.axis ? o : r, h = "x" === n.axis ? o : r, c = [];
                    let d, u, g, f;
                    for (u = (d = i) + s; d < u; ++d)
                        (f = e[d]),
                ...
                getLabelAndValue(t) {
                    const e = this._cachedMeta, { iScale: i, vScale: s } = e, a = this.getParsed(t), n = a._custom, o = ua(n)
                        ? "[" + n.start + ", " + n.end + "]"
                ...
                updateElements(e, i, s, a) {
                    const n = "reset" === a, { index: o, _cachedMeta: { vScale: r }, } = this, l = r.getBasePixel(), h = r.isHorizontal(), c = this._getRuler(), { sharedOptions: d, includeOptions: u } = this._getSharedOptions(i, a);
                    for (let t = i; t < i + s; t++) {
                        const i = this.getParsed(t), s = n || P(i[r.axis])
                            ? { base: l, head: l }
                            : this._calculateBarValuePixels(t), m = this._calculateBarIndexPixels(t, c), b = (i._stacks || {})[r.axis], x = {
                            horizontal: h,
                            base: s.base,
                ...
                _getStacks(t, i) {
                    const e = this._cachedMeta["iScale"], s = e
                        .getMatchingVisibleMetas(this._type)
                        .filter((t) => t.controller.options.grouped), a = e.options.stacked, n = [];
                    for (const e of s)
                        if ((void 0 === i ||
                            !((t) => {
                ...
                _calculateBarValuePixels(t) {
                    ...
                    if (((c = this.chart.getDataVisibility(t)
                        ...
                        (d =
                            ...
                            u === o && (x -= d / 2);
                        const t = e.getPixelForDecimal(0), P = e.getPixelForDecimal(1), a = Math.min(t, P), l = Math.max(t, P);
                ...
                _calculateBarIndexPixels(t, e) {
                    ...
                    let o, r;
                    if (e.grouped) {
                        const i = a ? this._getStackCount(t) : e.stackCount, T = ("flex" === s.barThickness
                            ? function (t, e, i, s) {
            ...
            BubbleController: class extends Os {
                ...
                getLabelAndValue(t) {
                    const e = this._cachedMeta, i = this.chart.data.labels || [], { xScale: s, yScale: a } = e, n = this.getParsed(t), o = s.getLabelForValue(n.x), r = a.getLabelForValue(n.y), l = n._custom;
                    return {
                        label: i[t] || "",
                        value: "(" + o + ", " + r + (l ? ", " + l : "") + ")",
                    };
                ...
                updateElements(e, i, s, a) {
                    const n = "reset" === a, { iScale: o, vScale: r } = this._cachedMeta, { sharedOptions: l, includeOptions: h } = this._getSharedOptions(i, a), c = o.axis, d = r.axis;
                    for (let t = i; t < i + s; t++) {
                        const i = e[t], s = !n && this.getParsed(t), u = {}, g = (u[c] = n
                            ? o.getPixelForDecimal(0.5)
                            : o.getPixelForValue(s[c])), f = (u[d] = n ? r.getBasePixel() : r.getPixelForValue(s[d]));
            ...
            LineController: class extends Os {
                ...
                updateElements(e, i, t, s) {
                    const a = "reset" === s, { iScale: n, vScale: o, _stacked: r, _dataset: l, } = this._cachedMeta, { sharedOptions: h, includeOptions: c } = this._getSharedOptions(i, s), d = n.axis, u = o.axis, { spanGaps: g, segment: f } = this.options, p = rt(g) ? g : Number.POSITIVE_INFINITY, m = this.chart._animationsDisabled || a || "none" === s, b = i + t, x = e.length;
            ...
            RadarController: class extends Os {
                ...
                updateElements(e, i, s, a) {
                    ...
                    for (let t = i; t < i + s; t++) {
                        const i = e[t], s = this.resolveDataElementOptions(t, i.active ? "active" : a), r = n.getPointPositionForValue(t, this.getParsed(t).r), l = o ? n.xCenter : r.x, h = o ? n.yCenter : r.y, c = {
                            x: l,
                            y: h,
                            angle: r.angle,
            ...
            ScatterController: class extends Os {
                ...
                getLabelAndValue(t) {
                    const e = this._cachedMeta, i = this.chart.data.labels || [], { xScale: s, yScale: a } = e, n = this.getParsed(t), o = s.getLabelForValue(n.x), r = a.getLabelForValue(n.y);
                ...
                update(t) {
                    ...
                    if (((this._drawStart = a),
                        ...
                        const { dataset: a, _dataset: n } = e, o = ((a._chart = this.chart),
                ...
                updateElements(e, i, s, a) {
                    const n = "reset" === a, { iScale: o, vScale: r, _stacked: l, _dataset: h, } = this._cachedMeta, t = this.resolveDataElementOptions(i, a), c = this.getSharedOptions(t), d = this.includeOptions(a, c), u = o.axis, g = r.axis, { spanGaps: f, segment: p } = this.options, m = rt(f) ? f : Number.POSITIVE_INFINITY, b = this.chart._animationsDisabled || n || "none" === a;
                    let x = 0 < i && this.getParsed(i - 1);
                    for (let t = i; t < i + s; ++t) {
                        const i = e[t], s = this.getParsed(t), f = b ? i : {}, v = P(s[g]), _ = (f[u] = o.getPixelForValue(s[u], t)), y = (f[g] =
                            n || v
                                ? r.getBasePixel()
        ...
        function va(t, e, i, s, a, n) {
            ...
            var c = (g - Math.max(0.001, g * d - i / S) / d) / 2, g = l + c + u, l = a - c - u, { outerStart: c, outerEnd: f, innerStart: p, innerEnd: m, } = (function (t, e, i, s) {
            ...
            })(e, h, d, l - g), b = d - c, x = d - f, v = g + c / b, _ = l - f / x, y = h + p, M = h + m, w = g + p / y, k = l - m / M;
            if ((t.beginPath(), n)) {
                const e = (v + _) / 2;
                ...
                t.moveTo(o, r);
                const e = Math.cos(v) * d + o, i = Math.sin(v) * d + r, s = (t.lineTo(e, i), Math.cos(_) * d + o), a = Math.sin(_) * d + r;
                t.lineTo(s, a);
            }
            t.closePath();
        }
        ...
        function Ma(t, e, i = {}) {
            var t = t.length, { start: i = 0, end: s = t - 1 } = i, { start: a, end: n } = e, o = Math.max(i, a), r = Math.min(s, n);
            return {
                count: t,
                start: o,
                loop: e.loop,
        ...
        function wa(t, e, i, s) {
            const { points: a, options: n } = e, { count: o, start: r, loop: l, ilen: h } = Ma(a, i, s), c = n.stepped
                ? We
        ...
        class Da extends e {
            ...
            path(t, e, i) {
                ...
                for (const o of s)
                    n &= a(t, this, o, { start: e, end: e + i - 1 });
                return !!n;
            }
            draw(t, e, i, s) {
        ...
        var Ra = Object.freeze({
            ...
            ArcElement: class extends e {
                ...
                inRange(t, e, i) {
                    var { angle: t, distance: e } = ut(this.getProps(["x", "y"], i), {
                        x: t,
                        y: e,
                    }), { startAngle: i, endAngle: s, innerRadius: a, outerRadius: n, circumference: o, } = this.getProps([
                        "startAngle",
                        "endAngle",
                        "innerRadius",
                        "outerRadius",
                        "circumference",
                    ], i), r = (this.options.spacing + this.options.borderWidth) / 2, o = T(o, s - i) >= _ || pt(t, i, s), t = c(e, a + r, n + r);
                    return o && t;
                }
                getCenterPoint(t) {
                    var { x: t, y: e, startAngle: i, endAngle: s, innerRadius: a, outerRadius: n, } = this.getProps([
                        "x",
                        "y",
                        "startAngle",
                        "endAngle",
                        "innerRadius",
                        "outerRadius",
                    ], t), { offset: o, spacing: r } = this.options, i = (i + s) / 2, s = (a + n + r + o) / 2;
                ...
                draw(e) {
                    ...
                    if (((this.pixelMargin = "inner" === i.borderAlign ? 0.33 : 0),
                        ...
                        var g = e, d = this, u = r, a = n, s = o, { fullCircles: f, startAngle: i, circumference: h, options: r, } = d, { borderWidth: n, borderJoinStyle: o, borderDash: p, borderDashOffset: m, } = r, r = "inner" === r.borderAlign;
                        if (n) {
                            g.setLineDash(p || []),
                                (g.lineDashOffset = m),
                                r
            ...
            BarElement: class extends e {
                ...
                draw(t) {
                    const { inflateAmount: e, options: { borderColor: i, backgroundColor: s }, } = this, { inner: a, outer: n } = ((u = Oa((r = this))),
                        (g = u.right - u.left),
                        (f = u.bottom - u.top),
                        (c = g / 2),
                        (p = f / 2),
        ...
        class Fa extends zs {
            ...
            getTickLimit() {
                ...
                return (i
                    ? 1e3 <
                        ...
                        (console.warn(`scales.${this.id}.ticks.stepSize: ${i} would result generating up to ${t} ticks. Limiting to 1000.`),
                            (t = 1e3))
            ...
            buildTicks() {
                ...
                const s = (function (t, e) {
                    const i = [], { bounds: s, step: a, min: n, max: o, precision: r, count: l, maxTicks: h, maxDigits: c, includeBounds: d, } = t, u = a || 1, g = h - 1, { min: f, max: p } = e, m = !P(n), b = !P(o), x = !P(l), v = (p - f) / (c + 1);
        ...
        class ja extends zs {
            ...
            buildTicks() {
                const t = this.options, e = (function (t, { min: e, max: i }) {
                    ...
                    let d = Math.floor((h - c) / Math.pow(10, n)), u = g(t.min, Math.round((l + c + d * Math.pow(10, n)) * o) / o);
                    for (; u < i;)
        ...
        function Ua(e) {
            ...
            for (let t = 0; t < o; t++) {
                ...
                n[t] = o.padding;
                var h = e.getPointPosition(t, e.drawingArea + n[t], l), c = z(o.font), d = ((d = e.ctx),
                    (c = c),
                    (u = O((u = e._pointLabels[t])) ? u : [u]),
                    { w: Ee(d, c.string, u), h: u.length * c.lineHeight }), u = ((a[t] = d), v(e.getIndexAngle(t) + l)), c = Math.round(ct(u));
                {
                    g = void 0;
                    f = void 0;
                    p = void 0;
            ...
            e.setCenterPoint(i.l - s.l, s.r - i.r, i.t - s.t, s.b - i.b),
                (e._pointLabelItems = (function (e, i, s) {
                    const a = [], n = e._pointLabels.length, t = e.options, { centerPointLabels: o, display: r } = t.pointLabels, l = { extra: Ya(t) / 2, additionalAngle: o ? S / n : 0 };
                    let h;
                    for (let t = 0; t < n; t++) {
                        (l.padding = s[t]), (l.size = i[t]);
                        const n = (function (t, e, i) {
                            const s = t.drawingArea, { extra: a, additionalAngle: n, padding: o, size: r } = i, l = t.getPointPosition(e, s + a + o, n), h = Math.round(ct(v(l.angle + D))), c = (function (t, e) {
                                return (90 === h || 270 === h
                                    ? (t -= e / 2)
                                    : (270 < h || h < 90) && (t -= e),
                                    t);
        ...
        class en extends zs {
            ...
            _generate() {
                const t = this._adapter, e = this.min, i = this.max, s = this.options, a = s.time, n = a.unit || Ja(a.minUnit, e, i, this._getLabelCapacity(e)), o = T(s.ticks.stepSize, 1), r = "week" === n && a.isoWeekday, l = rt(r) || !0 === r, h = {};
                let c, d, u = e;
                        ...
                        if ("y" !== ki([s, r.options.indexAxis]) &&
                            ...
                            if (("linear" === t.type || "time" === t.type) &&
                                ...
                                var { start: n, count: o } = (function (t) {
                                    var e = t.length;
                                    let i, s = 0;
                                    const a = h["iScale"], { min: n, max: o, minDefined: r, maxDefined: l, } = a.getUserBounds();
                                        ...
                                        case "lttb":
                                            t = (function (s, a, n, t) {
                                                ...
                                                for (o[l++] = s[p], c = 0; c < e - 2; c++) {
                                                    let t, e = 0, i = 0;
                                                    const h = Math.floor((c + 1) * r) + 1 + a, _ = Math.min(Math.floor((c + 2) * r) + 1, n) + a, y = _ - h;
                                                    for (t = h; t < _; t++)
                                                        (e += s[t].x), (i += s[t].y);
                                                    (e /= y), (i /= y);
                                                    var m = Math.floor(c * r) + 1 + a, b = Math.min(Math.floor((c + 1) * r) + 1, n) + a, { x, y: v } = s[p];
                                                    for (u = -1, t = m; t < b; t++)
                                                        (g =
                                                            0.5 *
                                                                Math.abs((x - e) * (s[t].y - v) -
                                                                    (x - s[t].x) * (i - v))) > u && ((u = g), (d = s[t]), (f = t));
                                                    (o[l++] = d), (p = f);
                                                }
                                                return (o[l++] = s[h]), o;
                                            })(a, n, o, l);
        ...
        function Mn(t) {
            ...
            s = (function (t) {
                ...
                if (e.getPointPositionForValue) {
                    var i = t;
                    const { scale: a, fill: n } = i, o = a.options, r = a.getLabels().length, l = o.reverse ? a.max : a.min, h = ((i = n),
                        (e = a),
                        "start" === i
                            ? l
                            : "end" === i
        ...
        function Sn(e, i) {
            const { line: s, target: a, property: n, color: o, scale: r } = i, l = (function (t, e, i) {
                ...
                for (const t of s) {
                    ...
                    if (e.segments) {
                        ...
                        o.push({ source: t, target: h, start: a[r], end: a[l] });
                }
                return o;
            })(s, a, n);
            for (const { source: i, target: p, start: m, end: b } of l) {
                ...
                var h = e, c = r, d = x && pn(n, m, b), { top: c, bottom: u } = c.chart.chartArea, { property: d, start: g, end: f } = d || {}, d = ("x" === d &&
        ...
        class On extends e {
            ...
            fit() {
                ...
                if (i.display) {
                    var a = i.labels, n = z(a.font), o = n.size, r = this._computeTitleHeight(), { boxWidth: a, itemHeight: l } = Cn(a, o);
                    let t, e;
                    (s.font = n.string),
                        this.isHorizontal()
            ...
            adjustHitBoxes() {
                if (this.options.display) {
                    const i = this._computeTitleHeight(), { legendHitBoxes: s, options: { align: a, labels: { padding: n }, rtl: t, }, } = this, o = Di(t, this.left, this.width);
                    if (this.isHorizontal()) {
            ...
            _draw() {
                ...
                this.drawTitle(),
                    ...
                    (u.lineWidth = 0.5),
                    (u.font = b.string);
                const { boxWidth: M, boxHeight: w, itemHeight: k } = Cn(f, v), S = this.isHorizontal(), P = this._computeTitleHeight(), D = ((y = S
                    ? {
        ...
        var Tn = {
            ...
            defaults: {
                ...
                labels: {
                    ...
                    padding: 10,
                    generateLabels(t) {
                        const s = t.data.datasets, { usePointStyle: a, pointStyle: n, textAlign: o, color: r, useBorderRadius: l, borderRadius: h, } = t.legend.options["labels"];
        ...
        function Vn(t, e) {
            const i = t.chart.ctx, { body: s, footer: a, title: n } = t, { boxWidth: o, boxHeight: r } = e, l = z(e.bodyFont), h = z(e.titleFont), c = z(e.footerFont), d = n.length, u = a.length, g = s.length, f = I(e.padding);
            let p = f.height, m = 0, b = s.reduce((t, e) => t + e.before.length + e.lines.length + e.after.length, 0), x = ((b += t.beforeBody.length + t.afterBody.length),
                d &&
                    (p +=
                        d * h.lineHeight +
                            (d - 1) * e.titleSpacing +
        ...
        function Wn(t, i, e, s) {
            var { caretSize: t, caretPadding: a, cornerRadius: n } = t, { xAlign: o, yAlign: r } = e, l = t + a, { topLeft: e, topRight: a, bottomLeft: n, bottomRight: h } = wi(n);
            let c = (function () {
                let { x: t, width: e } = i;
        ...
        class $n extends e {
            ...
            _createItems(s) {
                ...
                for (e = 0, r = t.length; e < r; ++e)
                    l.push((function (t, e) {
                        const { element: i, datasetIndex: s, index: a } = e, n = t.getDatasetMeta(s).controller, { label: o, value: r } = n.getLabelAndValue(a);
                        return {
                            chart: t,
                            label: o,
            ...
            update(t, e) {
                ...
                let a, n = [];
                if (s.length) {
                    const t = zn[i.position].call(this, s, this._eventPosition), e = ((n = this._createItems(i)),
                        ...
                        (this._size = Vn(this, i))), o = Object.assign({}, t, e), r = Bn(this.chart, i, o), l = Wn(i, o, r, this.chart);
            ...
            getCaretPosition(t, e, i) {
                var { xAlign: s, yAlign: a } = this, { caretSize: i, cornerRadius: n } = i, { topLeft: n, topRight: o, bottomLeft: r, bottomRight: l } = wi(n), { x: t, y: h } = t, { width: e, height: c } = e;
                let d, u, g, f, p, m;
                return ("center" === a
                    ? ((p = h + c / 2),
                        (m =
            ...
            _drawColorBox(t, e, i, s, a) {
                const n = this.labelColors[i], o = this.labelPointStyles[i], { boxHeight: r, boxWidth: l } = a, h = z(a.bodyFont), c = Nn(this, "left", a), d = s.x(c), u = r < h.lineHeight ? (h.lineHeight - r) / 2 : 0, g = e.y + u;
                if (a.usePointStyle) {
                    const e = {
            ...
            drawBody(e, i, t) {
                const s = this["body"], { bodySpacing: a, bodyAlign: n, displayColors: o, boxHeight: r, boxWidth: l, boxPadding: h, } = t, c = z(t.bodyFont);
